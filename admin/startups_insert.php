...
<?php
    ...
    if(!isset($_SESSION['login'])){
		...
		if(!$title || !$description || !$image_url || !$priority){
			header("Location: ../admin.php");
		}
		else{
			$con = mysqli_connect('localhost', 'root', '', 'edc');
			$sql = "INSERT INTO startups (title, description, image_url, priority) VALUES ('".$_POST['title']."','".$_POST['description']."','$image_url','".$_POST['priority']."')";
