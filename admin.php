...
<section class="pt-large pb-large">
                        ...
                        <!-- NEWS AND UPDATES -->
							<div class="tabs-minimal tabs-center">
								<ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
									<li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">News and Updates</a></li>
								</ul>
									...
									<div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/news_insert.php" method="POST">
                                            <span>Heading:</span>
                                            ...
                                            <br> <br>
                                            <input type="submit" name="Add the news" class="btn" title="Add the news">
                                        </form>
									</div>
                            ...
                            <div class="tabs-minimal tabs-center">
                                <ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">Gallery</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/gallery_insert.php" method="POST" enctype="multipart/form-data">
                                            <span>Heading:</span>
                                            <input type="text" name="heading"><br><br>
                                            ...
                                            <br> <br>
                                            <input type="submit" name="Add to the gallery" class="btn" title="Add to the gallery">
                                        </form>
                                    </div>
                            ...
                            <div class="tabs-minimal tabs-center">
                                <ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">Our Associates</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/associates_insert.php" method="POST" enctype="multipart/form-data">
                                            <span>Heading:</span>
                                            <input type="text" name="heading"><br><br>
                                            ...
                                            <br> <br>
                                            <input type="submit" name="Add our Associates" class="btn" title="Add our Associates">
                                        </form>
                            ...
                            <div class="tabs-minimal tabs-center">
                                <ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">Events</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/event_insert.php" method="POST" enctype="multipart/form-data">
                                            <span>Title:</span>
                                            ...
                                            <input type="file" name="image_url">
                                            <br> <br>
                                            <input type="submit" name="Add to our events" class="btn" title="Add to our events">
                                        </form>
                                    </div>
                            ...
                            <div class="tabs-minimal tabs-center">
                                <ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">Team</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/team_insert.php" method="POST" enctype="multipart/form-data">
                                            <span>FirstName:</span>
                                            ...
                                            <input type="file" name="image_url">
                                            <br> <br>
                                            <input type="submit" name="Add to our team" class="btn" title="Add to our team">
                                        </form>
                                    </div>
                            ...
                            <div class="tabs-minimal tabs-center">
                                <ul id="myTabMinimal" class="nav nav-tabs" role="tablist">
                                    <li class="active"><a href="#first-tab-2" role="tab" data-toggle="tab">Startup Portfolio</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade active in" id="first-tab-2">
                                        ...
                                        <form action="admin/startups_insert.php" method="POST" enctype="multipart/form-data">
                                            <span>Title:</span>
                                            <input type="text" name="title"><br><br>
                                            ...
                                            <input type="file" name="image_url">
                                            <br> <br>
                                            <input type="submit" name="Add to our Startups" class="btn" title="Add to our Startups">
                                        </form>
                                    </div>
			...
			<!-- / text blocks centered-->
                ...
                <form action="admin/logout.php" class="tabs-center">
                    <button name="Add to our Startups" class="btn" title="Add to our Startups">Logout</button>   
                </form>
