...
<body class="activate-appear-animation header-transparent header-dark nav-style-1">
	...
	<div id="global-wrapper">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<ul class="quick-menu">
								<li><a href="template-site-map.html" class="linkup">Site map</a></li>
				...
				<nav class="navbar navbar-default" >
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.html">
							...
							<img src="images/logo.png" alt="LOGO" class="main-logo-light" height="60" width="120" />
						</a>
						<!-- /Logo -->
					</div>
		...
		<!-- / header -->
<main id="content">
			<header class="page-header top-center x-large image-background image-11 dark-color center no-padding">
				<div class="mask opacity-3">

					<div class="container v-align-center">
						<div class="row">
							<div class="col-md-12 text-light">
								<h1 class="x-large block">Our team</h1>
								<p class="lead">
									We are a team of experimented web developers and designers
								</p>
							</div>
						</div>
					</div>
			...
			<section class="pt-large pb-large">
				<div class="container">
					<div class="row">
						<div class="col-md-12 mb-medium heading">
							<h2>We're Amazing people<span>Meet our team</span></h2>
						</div>
					</div>

					<div class="row">
						<div class="col-md-3" data-nekodelay="100">

							<article class="feature-box media-up">
								<div class="icon  x-large">
									<img src="img/Akhil.png" alt="handsome member" class="circle">
								</div>
