...
$(document).ready(function() {  
	...
	'<li><a href="neko-framework/css/color/neko-framework-blue.css" style="background:#32408F">Dark blue</a></li>' +
	'<li><a href="neko-framework/css/color/neko-framework-dodger.css" style="background:#0C7CD5">Dodger</a></li>' +
	'<li><a href="neko-framework/css/color/neko-framework-light-blue.css" style="background:#008FA1">Light blue</a></li>' +
	'<li><a href="neko-framework/css/color/neko-framework-sea-green.css" style="background:#00635A">Sea green</a></li>' +
	'<li><a href="neko-framework/css/color/neko-framework-green.css" style="background:#3D8B40">Green</a></li>' +
	...
	'<li><a href="neko-framework/css/color/neko-framework-olive.css" style="background:#71A436">Olive</a></li>' +
